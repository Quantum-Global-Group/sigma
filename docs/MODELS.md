...
| **Options — volatility risk premium** | `vol_premium_experiment.py`, short VXX 2009–2026 (split/div-adj) | **REAL structural edge, but uninvestable naked** — implied vol > realized: VXX lost −100%, short-vol earned +26% CAGR (Sharpe 0.70). BUT maxDD **−92%**, worst day −39%, **2018 −69% / 2020 −69%** (the XIV blow-up). Trend-filtering cut the spikes (2018 −13%, 2020 −21%) but not the 2022 grind (−41%), DD still −77%. Risk-adjusted it loses to SPY (0.60–0.70 vs 0.91). The premium is genuine; harvesting it survivably needs **defined-risk option structures** (credit spreads / iron condors, capped max loss) sized as a small **sleeve**, not naked short vol. |
